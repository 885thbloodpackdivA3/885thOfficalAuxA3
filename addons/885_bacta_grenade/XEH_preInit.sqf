...
[
  "bacta_partsPerTick",
  "SLIDER",
  ["Body Parts Treated Per Tick", "How many injured body parts are bandaged/stitched/splinted each heal tick. 0 = treat every injured part at once (fastest, ignores hit location)."],
  ["Bacta", "Healing"],
  [0, 6, 0, 0],
  1
] call CBA_fnc_addSetting;
