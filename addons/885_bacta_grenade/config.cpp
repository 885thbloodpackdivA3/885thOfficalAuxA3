...
class CfgMagazines
{
    ...
    {
        author = "TCP + 885th Bloodpack Division";
        scope = 2;
...
class CfgFunctions {
  class bacta {
    tag = "bacta";
    class main {
      file = "\885_bacta_grenade\functions";
...
class Extended_PreInit_EventHandlers {
  class bacta_preinit {
    init = "call compile preprocessFileLineNumbers '\885_bacta_grenade\XEH_preInit.sqf'";
  };
};

class Extended_PostInit_EventHandlers {
  class bacta_postinit {
    init = "call compile preprocessFileLineNumbers '\885_bacta_grenade\XEH_postInit.sqf'";
  };
};
